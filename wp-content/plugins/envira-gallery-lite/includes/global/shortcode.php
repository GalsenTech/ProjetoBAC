...
class Envira_Gallery_Shortcode {
    ...
    public function __construct() {
		...
		// wp_register_script( $this->base->plugin_slug . '-script', plugins_url( 'assets/js/lib/jquery.justifiedGallery.js', $this->base->file ), array( 'jquery' ), $this->base->version, true );
		// wp_register_script( $this->base->plugin_slug . '-script', plugins_url( 'assets/js/lib/enviraJustifiedGallery-extensions.js', $this->base->file ), array( 'jquery' ), $this->base->version, true );
		// wp_register_script( $this->base->plugin_slug . '-script', plugins_url( 'assets/js/lib/touchsupport.js', $this->base->file ), array( 'jquery' ), $this->base->version, true );
		// wp_register_script( $this->base->plugin_slug . '-script', plugins_url( 'assets/js/lib/touchswipe.js', $this->base->file ), array( 'jquery' ), $this->base->version, true );
		// wp_register_script( $this->base->plugin_slug . '-script', plugins_url( 'assets/js/lib/mousewheel.js', $this->base->file ), array( 'jquery' ), $this->base->version, true );
		// wp_register_script( $this->base->plugin_slug . '-script', plugins_url( 'assets/js/lib/imagesloaded.js', $this->base->file ), array( 'jquery' ), $this->base->version, true );
		// wp_register_script( $this->base->plugin_slug . '-script', plugins_url( 'assets/js/lib/isotope.js', $this->base->file ), array( 'jquery' ), $this->base->version, true );
		// wp_register_script( $this->base->plugin_slug . '-script', plugins_url( 'assets/js/lib/fancybox.js', $this->base->file ), array( 'jquery' ), $this->base->version, true );
		// wp_register_script( $this->base->plugin_slug . '-script', plugins_url( 'assets/js/lib/fancybox-buttons.js', $this->base->file ), array( 'jquery' ), $this->base->version, true );
		// wp_register_script( $this->base->plugin_slug . '-script', plugins_url( 'assets/js/lib/fancybox-media.js', $this->base->file ), array( 'jquery' ), $this->base->version, true );
		// wp_register_script( $this->base->plugin_slug . '-script', plugins_url( 'assets/js/lib/fancybox-thumbs.js', $this->base->file ), array( 'jquery' ), $this->base->version, true );
		// wp_register_script( $this->base->plugin_slug . '-script', plugins_url( 'assets/js/lib/fancybox-video.js', $this->base->file ), array( 'jquery' ), $this->base->version, true );
		// wp_register_script( $this->base->plugin_slug . '-script', plugins_url( 'assets/js/lib/responsivelyLazy.js', $this->base->file ), array( 'jquery' ), $this->base->version, true );
    ...
    */
    public function generate_gallery_item_markup( $gallery, $data, $item, $id, $i ) {
		...
		//Wilson: Desabilitando essa regra. Link sempre será clicável, se existir
